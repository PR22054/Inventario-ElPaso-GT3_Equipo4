<div class="container is-fluid mb-6">
    <div class="contenedor-destacado">
        ...
        <h2 class="subtitle">Lista de herramientas por categoría</h2>
                    ...
                    <?php
                        ...
                        if($categorias->rowCount()>0){
                            ...
                            foreach($categorias as $row){
                                echo '<a href="index.php?vista=herramienta_category&category_id='.$row['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$row['categoria_nombre'].'</a>';
                            }
                        }else{
                ...
                <div class="column">
                    <?php
                        ...
                        if($check_categoria->rowCount()>0){
                            ...
                            $url="index.php?vista=herramienta_category&category_id=$categoria_id&page="; /* <== */
                            $registros=15;
                            $busqueda="";
