			...
			<form action="./php/herramienta_guardar.php" method="POST" class="FormularioAjax" autocomplete="off"
				...
				<div class="columns">
					<div class="column is-full">
						<div class="control">
							...
							<textarea class="textarea" name="herramienta_descripcion" maxlength="299" rows="4" required></textarea>
						</div>
					</div>
				</div>
				...
				<div class="columns">
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_precio" step="0.01" min="0" max="999999.99" 
					...
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_stock" min="0" max="999999" 
					...
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_stock_maximo" min="0" max="999999" 
								placeholder="0" onkeypress="return soloNumeros(event)" required>
						</div>
					</div>
					...
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_stock_minimo" min="0" max="999999" 
								placeholder="0" onkeypress="return soloNumeros(event)" required>
						</div>
					</div>
				...
				<div class="columns">
					<div class="column is-4">
						<label>¿Necesita mantenimiento?</label><br>
						<div class="select is-rounded">
							<select name="necesita_mantenimiento" required>
