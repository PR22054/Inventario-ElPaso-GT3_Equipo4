...
<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle">Buscar categoría</h2>
        ...
        <div class="container pb-6 pt-6">
            <?php
                // Usamos la misma lógica PHP para mostrar el formulario o los resultados de la búsqueda.
                        ...
                        <div class="field is-grouped">
                            <p class="control is-expanded" style="position: relative;">
                                <input class="input is-rounded" type="text" name="txt_buscador" 
                                       id="input_buscador_categoria"
                                       placeholder="¿Qué estás buscando?" 
                                       pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ \-']{1,50}" maxlength="50" >
                                
                                <div id="resultados_autocompletado_categoria" class="dropdown-content" 
            ...
            <script>
                const inputBuscador = document.getElementById('input_buscador_categoria');
                const resultadosContenedor = document.getElementById('resultados_autocompletado_categoria');
                let timeout = null;
                ...
                inputBuscador.addEventListener('input', function() {
                    ...
                    timeout = setTimeout(() => {
                        fetch('./php/buscador_autocomplete.php', {
                            ...
                            // Enviar el término y el módulo 'categoria'
                            body: 'termino=' + encodeURIComponent(termino) + '&modulo=categoria'
                        })
                ...
                document.addEventListener('click', function(e) {
                    if (e.target !== inputBuscador && e.target.closest('#resultados_autocompletado_categoria') === null) {
                        resultadosContenedor.style.display = 'none';
                    }
                });
            </script>
