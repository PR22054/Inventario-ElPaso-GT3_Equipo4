<?php
    ...
    if(isset($_POST['aplicar_filtros'])){
        $_SESSION['filtro_ordenar_codigo'] = limpiar_cadena($_POST['ordenar_codigo'] ?? '');
    ...
    if(isset($_POST['limpiar_filtros'])){
        unset($_SESSION['filtro_ordenar_codigo']);
...
<div class="container is-fluid mb-6">
    <div class="contenedor-destacado">
        ...
        <div class="container pb-6 pt-6">
                        ...
                        <div class="field is-grouped">
                            <p class="control is-expanded" style="position: relative;">
                                <input class="input is-rounded" type="text" name="txt_buscador" 
                                       id="input_buscador_producto"
                                       placeholder="¿Qué estás buscando?" 
                                       pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ \-']{1,50}" maxlength="50" >
                                
                                <div id="resultados_autocompletado_producto" class="dropdown-content" 
            ...
            <script>
                const inputBuscador = document.getElementById('input_buscador_producto');
                const resultadosContenedor = document.getElementById('resultados_autocompletado_producto');
                let timeout = null;
                ...
                inputBuscador.addEventListener('input', function() {
                    ...
                    timeout = setTimeout(() => {
                        fetch('./php/buscador_autocomplete.php', {
                            ...
                            body: 'termino=' + encodeURIComponent(termino) + '&modulo=producto'
                        })
                ...
                document.addEventListener('click', function(e) {
                    if (e.target !== inputBuscador && e.target.closest('#resultados_autocompletado_producto') === null) {
                        resultadosContenedor.style.display = 'none';
                    }
                });
            </script>
            ...
            <div class="filtros-container">
                ...
                <form action="" method="POST">
                    <div class="filtros-grid">
                        <!-- Filtro: Ordenar por Código -->
                        <div class="filtro-grupo">
                            <label>Ordenar por Código</label>
                            <div class="select is-fullwidth">
                                <select name="ordenar_codigo">
                                    <option value="">Sin ordenar</option>
                                    <option value="ASC" <?php echo (isset($_SESSION['filtro_ordenar_codigo']) && $_SESSION['filtro_ordenar_codigo']=='ASC') ? 'selected' : ''; ?>>A-Z (0-9)</option>
                                    <option value="DESC" <?php echo (isset($_SESSION['filtro_ordenar_codigo']) && $_SESSION['filtro_ordenar_codigo']=='DESC') ? 'selected' : ''; ?>>Z-A (9-0)</option>
                                </select>
                            </div>
                        </div>
