				...
				<div class="columns">
					<div class="column is-full">
						<div class="control">
							...
							<textarea class="textarea" name="herramienta_descripcion" maxlength="300" required><?php echo $datos['herramienta_descripcion']; ?></textarea>
						</div>
					</div>
				</div>
					...
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_precio" step="0.01" min="0" max="999999.99" 
								...
								value="<?php echo number_format($datos['herramienta_precio'], 2, '.', ''); ?>">
						</div>
					</div>
					<div class="column">
						<div class="control">
							...
							<input class="input" type="number" name="herramienta_stock" min="0" max="999999" 
								...
								value="<?php echo intval($datos['herramienta_stock']); ?>">
						</div>
					</div>
					<div class="column">
...
<script>
// Función para decimal automáticamente
