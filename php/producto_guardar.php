...
$stock_maximo = limpiar_cadena($_POST['producto_stock_maximo']);
$stock_minimo = limpiar_cadena($_POST['producto_stock_minimo']);
$categoria = limpiar_cadena($_POST['producto_categoria']);


/*== Verificando campos obligatorios ==*/
if ($codigo == "" || $nombre == "" || $precio == "" || $stock == "" || $stock_maximo == "" || $stock_minimo == ""  || $categoria == "") {
    echo '
...
$guardar_producto = $guardar_producto->prepare("INSERT INTO producto(producto_codigo,producto_nombre,producto_precio,producto_stock,stock_maximo,stock_minimo,producto_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:stock_maximo,:stock_minimo,:foto,:categoria,:usuario)");
$marcadores = [
    ":codigo" => $codigo,
    ":nombre" => $nombre,
    ":precio" => $precio,
