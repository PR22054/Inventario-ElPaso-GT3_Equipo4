<?php
    ...
    $tipoCat=limpiar_cadena($_POST['categoria_tipo']);
    ...
    $tipos_permitidos_cat = ['producto', 'herramienta', 'ambas'];
   if(!in_array($tipoCat, $tipos_permitidos_cat)){
        echo '
            <div class="notification is-danger is-light">
                <strong>¡Ocurrio un error inesperado!</strong><br>
    ...
    $actualizar_categoria=$actualizar_categoria->prepare("UPDATE categoria SET categoria_nombre=:nombre,categoria_ubicacion=:ubicacion, categoria_tipo=:tipoCat WHERE categoria_id=:id");
