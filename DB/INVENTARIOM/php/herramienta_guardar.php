<?php
    ...
    $guardar_herramienta=$guardar_herramienta->prepare("INSERT INTO herramienta(herramienta_codigo,herramienta_nombre,herramienta_precio,herramienta_stock,herramienta_foto,categoria_id,usuario_id) VALUES(:codigo,:nombre,:precio,:stock,:foto,:categoria,:usuario)");
